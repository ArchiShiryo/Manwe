...
- [ ] R5.1 Réaliser le parcours de trois personnes et vingt événements depuis un espace vide. (En cours, 25 septembre : démontré de bout en bout sur P02 du lot R5-S02 ; lot non validé à cause des pertes de format de P01 ([RAPPORT-011](./manwe-next/docs/pilotage/rapports/RAPPORT-011.md)) ; lot R5-S03 à faire après D-025.)
