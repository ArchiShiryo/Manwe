...
- [ ] R5.8 Entretien guidé : l'agent voit toute la mémoire, repère les creux (milieux, personnes, périodes, lectures sans preuve) et pose une question à la fois dans la conversation ; l'utilisateur peut aussi écrire librement ou tenir son journal ; l'agent analyse seul, sans confirmation (D-028, D-029). Toute personne citée existe, même décrite sans nom, et son identité se met à jour rétrospectivement (D-030).
