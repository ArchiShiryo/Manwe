...
- [ ] R5.1 Réaliser le parcours de trois personnes et vingt événements depuis un espace vide. (En cours, 25 septembre : démontré de bout en bout sur P02 du lot R5-S02 ; lot non validé à cause des pertes de format de P01 ([RAPPORT-011](./manwe-next/docs/pilotage/rapports/RAPPORT-011.md)) ; lot R5-S03 : les deux parcours passent en entier, 9/9 [L], mais lot non validé sur la taille des paquets ([RAPPORT-012](./manwe-next/docs/pilotage/rapports/RAPPORT-012.md)) ; lot R5-S04 : 9/9 [L], paquets réduits de 48,7 %, non validé à cause de la règle de choix du harnais ([RAPPORT-013](./manwe-next/docs/pilotage/rapports/RAPPORT-013.md)).)
...
- [ ] R5.4 Faire émerger un problème et un objectif de la conversation ; rendre leur formulation modifiable immédiatement. (En cours, 25 septembre : opération `propose_goal` (contrat 1.6, prompt v8), proposition non confirmée tant que l'utilisateur ne l'adopte pas, reformulation et écart sur l'écran Intentions (`scripts/ui-check-goal.mjs`) ; objectif proposé, cité et adopté sur P02 de R5-S02, perdu sur P01 ([RAPPORT-011](./manwe-next/docs/pilotage/rapports/RAPPORT-011.md)) ; proposé, cité et adopté sur les deux scénarios de R5-S03 ([RAPPORT-012](./manwe-next/docs/pilotage/rapports/RAPPORT-012.md)).)
...
- [ ] R5.6 Rejouer le parcours avec un autre groupe et d'autres noms, sans modifier le code, le contrat ni le prompt pour le scénario. Sol produit de nouvelles propositions à partir du seul paquet de contexte autorisé ; ne pas recopier les réponses attendues du corpus. (En cours : rejeu réussi sur P02 dans R5-S02 et R5-S03, même code, même contrat, même prompt ; validation attendue avec le lot R5-S04.)
