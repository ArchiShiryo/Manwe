...
- [ ] IA-A.4 Mesurer les durées et l'usage disponibles ; tester les budgets, l'annulation et la protection des secrets côté backend. (En partie, 25 septembre : durée d'inférence, usage et modèle servi enregistrés par réponse ; annulation testée ; la clé reste côté service (environnement ou proxy) et n'est jamais renvoyée. Reste : budgets.)
