...
| R3    | Hypothèses sourcées et corrections durables                 | R2                          | Importante        | En cours : moteur livré (R3.1-2, R3.4-8) ; R3-S01 noté, non validé ([RAPPORT-003](./manwe-next/docs/pilotage/rapports/RAPPORT-003.md)) ; BRIEF-003 puis lot de contrôle R3-S02 |
