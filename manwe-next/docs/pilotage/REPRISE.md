...
| IA-A, raccordement auto | IA-A.0, IA-A.2, IA-A.3 et IA-A.4 faits : fournisseur DeepSeek dans l'application, erreurs typées, un appel réel validé (D-023, à confirmer) ; restent IA-A.1 (Windows) et IA-A.5                                                      |
