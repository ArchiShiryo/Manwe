...
| IA-A, raccordement auto | IA-A.0, IA-A.2 et IA-A.3 faits : fournisseur DeepSeek dans l'application, erreurs typées, un appel réel validé (D-023, à confirmer) ; restent IA-A.1 (Windows), IA-A.4 (budgets), IA-A.5                                              |
...
cd manwe-next
npm ci
npm test            # 93 tests au 25 septembre 2026
npm run typecheck
