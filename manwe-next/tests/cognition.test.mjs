...
test("chaque demande enregistre l’empreinte du prompt analyst-v7 versionné", () =>
  withStore((store) => {
    ...
    for (const packet of requests) {
      ...
      assert.equal(packet.promptVersion, "analyst-v7");
      assert.equal(journal.promptVersion, "analyst-v7");
