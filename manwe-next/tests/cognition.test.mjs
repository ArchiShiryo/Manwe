...
test("chaque demande enregistre l’empreinte du prompt analyst-v6 versionné", () =>
  withStore((store) => {
    ...
    for (const packet of requests) {
      ...
      assert.equal(packet.promptVersion, "analyst-v6");
      assert.equal(journal.promptVersion, "analyst-v6");
