...
test("chaque demande enregistre l’empreinte du prompt analyst-v11 versionné", () =>
  withStore((store) => {
    ...
    for (const packet of requests) {
      ...
      assert.equal(packet.promptVersion, "analyst-v11");
      assert.equal(journal.promptVersion, "analyst-v11");
