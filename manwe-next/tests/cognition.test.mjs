...
test("chaque demande enregistre l’empreinte du prompt analyst-v9 versionné", () =>
  withStore((store) => {
    ...
    for (const packet of requests) {
      ...
      assert.equal(packet.promptVersion, "analyst-v9");
      assert.equal(journal.promptVersion, "analyst-v9");
